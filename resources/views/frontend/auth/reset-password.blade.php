            ...
            <div class="row">
                <div class="col-md-7 align-items-center justify-content-center d-none d-md-flex">
                    <div class="form-image text-center">
                        <img src="{{ asset('assets/frontend/images/reset.png') }}" style="height: 250px; width: auto;"
                ...
                <div class="col-md-5 bg-white vh-100 overflow-auto">
                    <div class="login-form-container">
                        <div class="logo">
                            <img src="{{ asset('assets/frontend/images/logo.png') }}" style="height: 24px; width: auto;"
                                alt="1">
                        </div>
                        ...
                        <form class="form mx-auto" method="POST" action="{{ route('password.update') }}">
                            @csrf
                                ...
                                <div class="input">
                                    <div class="form-outline position-relative">
                                        <input type="text"
                                            ...
                                            value="{{ old('email', $request->email) }}" autocomplete="email" autofocus
                                            readonly>
                                ...
                                <div class="input">
                                    <div class="form-outline position-relative">
                                        <input type="password"
                                            ...
                                            placeholder="New Password" name="password" autocomplete="current-password">
                                ...
                                <div class="input">
                                    <div class="form-outline position-relative">
                                        <input type="password"
                                            ...
                                            placeholder="New Password Repeat" name="password_confirmation"
                            ...
                            <div class="text-center text-lg-start mt-4 pt-2">
                                <div class="d-grid">
                                    ...
                                    <button type="submit" class="btn form-btn login-btn">Create Password</button>
                                ...
                                <p class="text-center pt-5 mt-3 condition">
                                    <a class="small mt-2 pt-1 mt-4" href="" style="color: #252525">Terms and
                                        Conditions</a>
                                    <a class="small mt-2 pt-1 mt-4 ps-4" href="" style="color: #252525">Privacy
                                        Policy</a>
                                </p>
                            </div>
