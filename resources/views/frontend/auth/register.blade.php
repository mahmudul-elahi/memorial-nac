                        ...
                        <form class="form mx-auto" action="{{ route('register') }}" method="post">
                            ...
                            <div class="text-center text-lg-start mt-4 pt-2">
                                <div class="d-grid">
                                    ...
                                    <button type="submit" class="btn form-btn login-btn">Register</button>

                                </div>


                                <p class="small fw-bold mt-2 pt-1 mt-4 text-center">Don't have an account yet?
                                    <a href="{{ url('login') }}" class="link-danger ps-2">Log in Now</a>
                                </p>

                                <p class="text-center pt-5 mt-3 condition">
                                    <a class="small mt-2 pt-1 mt-4" href="" style="color: #252525">Terms and
                                        Conditions</a>
                                    <a class="small mt-2 pt-1 mt-4 ps-4" href=""
