                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="mb-4">
                                                @foreach ($item->images as $image)
                                                    <img srcset="{{ asset('img/obituary/' . $item->id . '/' . $image->filename) }}"
                                                        width="150px" height="150px" class="rounded mx-1 my-2"
                                                        alt="" title="">
                                                @endforeach
                                            </div>

                                            <div class="input-group control-group img_div form-group">
                                                <input type="file" onchange="ValidateSize(this)" name="image"
