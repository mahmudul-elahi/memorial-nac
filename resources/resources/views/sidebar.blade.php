            ...
            <div class="row">
                ...
                <div class="col">
                    <div>
                        ...
                        <cite>{{ Str::limit($comment->content, 85, '...') }}</cite> <a href="{{ route('show.obituary', [$comment->item->id, $comment->item->slug]) }}" class="font-weight-bold">{{ $comment->item->title }}</a>
                    </div>
        ...
        <ul class="list list-timeline list-timeline-simple text-truncate">
            ...
            <li>
                ...
                <div class="list-timeline-content">
                    ...
                    <small class="text-muted">to <a href="{{ route('show.obituary', [$condolence->item->id, $condolence->item->slug]) }}">{{ $condolence->item->title }}</a></small>
                </div>
            </li>
            @endforeach
        </ul>
