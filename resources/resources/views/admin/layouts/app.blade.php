            ...
            function updateStatusPost(e, t) {
                $.ajaxSetup({
                    ...
                    $.ajax({
                        ...
                        success:function(t){
                            0==t.bool?$("#status-post-"+e).removeClass("badge bg-red-lt").addClass("badge bg-green-lt").text("Active"):1==t.bool&&$("#status-post-"+e).removeClass("badge bg-green-lt").addClass("badge bg-red-lt").text("Disabled")
                        }
                    })
                };
